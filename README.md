...
A production-style TypeScript API rate limiter with pluggable algorithms, framework-independent core logic, Express middleware, Redis-backed distributed enforcement, observability hooks, CI-tested integration tests, and benchmarks.
